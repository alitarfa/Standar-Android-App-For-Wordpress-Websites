package com.add.wordpressdroid.api.params;
...
public class HttpParams {
    ...
    //public static final String BASE_URL = "https://tr-studio.000webhostapp.com/";
    ...
    public static final String API_CATEGORISED_ALL_POST = "wp-json/wp/v2/posts?_embed=true";
